      ...
      <AnimatePresence>
        {showComingSoon && (
          <>
            ...
            >
              <div className="glass rounded-3xl p-12 max-w-md text-center shadow-2xl border-2 border-primary/20">
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                ...
                >
                  The SATRIA game demo is currently in development. Stay tuned for an epic gaming experience!
                </motion.p>
